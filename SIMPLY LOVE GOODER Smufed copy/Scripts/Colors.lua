...
function DifficultyColor( dc )
	...
	if color == 1 then return "#464646" end
	if color == 2 then return "#aae7e8" end
	if color == 3 then return "#ffe0f1" end
...
function DifficultyColorRGB( n )
	local color = n + Color() + 12
	color = math.mod(color-1,12)+1
	if color == 1 then return 0.2,0.2,0.2,1 end
	if color == 2 then return 0.7,1,0.9,1 end
	if color == 3 then return 1,0.7,1,1 end
...
function ColorRGB ( n )
	...
	if color == 1 then return 0.2,0.2,0.2,1 end
	if color == 2 then return 0.7,1,0.9,1 end
	if color == 3 then return 1,0.4,0.2,1 end
	if color == 4 then return 0.76,0,0.44,1 end
	if color == 5 then return 0.51,0,0.63,1 end
	if color == 6 then return 0.25,0.23,0.82,1 end
	if color == 7 then return 0,0.45,1,1 end
...
function TextOnColor (n)
	...
	color = math.mod(color-1,12)+1
	if color == 1 then return 1,1,1,1 end
