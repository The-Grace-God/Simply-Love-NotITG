...
function SLGJUVMDailyBackground()
	...
	t.OneChoiceForAllPlayers = true
	t.Choices = { "Daily", "Lucy", "Shame", "Banshee", "Hexagons", "GOODTEK", "Maze", "Zero", "Shader" }
	t.LoadSelections = function(self, list) if JUVMProfile().JUVMDailyBG == true then list[1] = true elseif JUVMProfile().JUVMDailyBG == 'Lucy' then list[2] = true elseif JUVMProfile().JUVMDailyBG == 'Shame' then list[3] = true elseif JUVMProfile().JUVMDailyBG == 'Banshee' then list[4] = true elseif JUVMProfile().JUVMDailyBG == 'Hexagons' then list[5] = true elseif JUVMProfile().JUVMDailyBG == 'GOODTEK' then list[6] = true elseif JUVMProfile().JUVMDailyBG == 'Maze' then list[7] = true elseif JUVMProfile().JUVMDailyBG == 'Zero' then list[8] = true elseif JUVMProfile().JUVMDailyBG == 'Shader' then list[9] = true else list[1] = true end end
	t.SaveSelections = function(self, list)
		...
		if list[9] then JUVMProfile().JUVMDailyBG = 'Shader'; end
	end
